...
class Contato(models.Model):
    ...
    captured_url = models.URLField(max_length=1000, blank=True, null=True)
    lead_source = models.CharField(max_length=500, blank=True, null=True)
    ...
    fbp = models.CharField(max_length=500, blank=True, null=True)
    fbc = models.CharField(max_length=500, blank=True, null=True)
